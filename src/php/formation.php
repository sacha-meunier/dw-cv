<section id="formation" class="formation-wrapper">
    ...
    <div class="formation-card-wrapper-holder">
        ...
        <div class="formation-card-sticky formation-card-sticky--blue">
            <article class="formation-card-wrapper">
                <div class="formation-heading-wrapper">
                    <h3 class="formation-heading" role="heading" aria-level="3">
                ...
                <div class="formation-p-wrapper-2">
                    ...
                    <p class="formation-p-2">
                        Devenir la meilleure version de sois est un objectif important pour moi, c'est pourquoi
                ...
                <div class="formation-p-wrapper-2">
                    <p class="formation-small-title formation-small-title-2">Montage vidéo
                    </p>
                    <p class="formation-p-2">
                ...
                <div class="formation-p-wrapper-2">
                    <p class="formation-small-title formation-small-title-2">Création de contenu
                    </p>
                    <p class="formation-p-2">
                        Depuis quelques années, j'étudie le fonctionnement des réseaux sociaux dans le but
                        d'utiliser ses outils à des fins professionnelles.
                    </p>
                    <!--<p class="formation-p-2 formation-p-tablet">
                        2020-2024
                    </p>-->
                </div>
                <div class="formation-divider"></div>
