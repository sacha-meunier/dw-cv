<header class="header" role="banner">
    <div class="header__wrapper">
        <h1>
            <a class="header__logo" href="#" aria-label="CV - homepage">
        ...
        <div>
            <a class="header__contact" href="#"><span class="header__contact-text">Discutons</span></a>
            ...
            <div class="nav-toggler">
                ...
                <nav class="nav-toggler__nav" id="primary-nav" role="navigation" aria-label="Mobile navigation">
                    ...
                    <ul class="nav-toggler__list">
                        <li class="nav-toggler__item"><a class="nav-toggler__link nav-toggler__link--active" href="#">Accueil</a></li>
                        <li class="nav-toggler__item"><a class="nav-toggler__link" href="#">Expériences pro</a></li>
                        <li class="nav-toggler__item"><a class="nav-toggler__link" href="#">Formation</a></li>
                    ...
                    <a class="contact__button" href="#">
                        ...
                        <div class="contact__button-icon-wrapper"><img class="contact__button-icon"
                                                                       src="/content/images/arrow-right-black.svg"
                                                                       width="18" height="18"
                                                                       alt="Icône mail"></div>
                    </a>
                    <section class="header__social">
                        ...
                        <ul class="header__social-list">
                            <li><a class="header__social-logo-link" href="https://dribbble.com/Zekiahs"><img
                                            class="header__social-logo-item" loading="lazy"
                                            src="../../content/images/icon-dribble.svg"
                                            alt="Icône de Dribbble" width="24" height="24"></a></li>
                            <li><a class="header__social-logo-link" href="https://twitter.com/ZekiahVFX"><img
                                            class="header__social-logo-item" loading="lazy"
                                            src="../../content/images/icon-twitter.svg"
                                            alt="Icône de Twitter" width="24" height="24"></a></li>
                            <li><a class="header__social-logo-link" href="https://www.instagram.com/zekiahrr"><img
                                            class="header__social-logo-item" loading="lazy"
                                            src="../../content/images/icon-instagram.svg"
                                            alt="Icône de Instagram" width="24" height="24"></a></li>
                            <li><a class="header__social-logo-link" href="https://www.youtube.com/@Zekiah"><img
                                            class="header__social-logo-item" loading="lazy"
                                            src="../../content/images/icon-youtube.svg"
                                            alt="Icône de Youtube" width="24" height="24"></a></li>
                            <li><a class="header__social-logo-link" href="#"><img class="header__social-logo-item"
                                                                                  loading="lazy"
                    ...
                    <div class="footer__location">
                        <svg class="footer__location-icon" width="16" height="16" viewBox="0 0 18 18" fill="#0F0928" xmlns="http://www.w3.org/2000/svg">
