<header class="header" role="banner">
    <div class="header__wrapper">
        ...
        <div>
            <a class="header__contact" data-type="white" data-action="trailer" data-magnetic="true" href="#"><span class="header__contact-text">Discutons</span></a>
                ...
                <nav class="nav-toggler__nav" id="primary-nav" role="navigation" aria-label="Mobile navigation">
                    ...
                    <section class="header__social">
                        ...
                        <ul class="header__social-list">
                            <li data-action="trailer" data-type="white"><a class="header__social-logo-link" href="https://dribbble.com/Zekiahs"><img
                            ...
                            <li data-action="trailer" data-type="white"><a class="header__social-logo-link" href="https://twitter.com/ZekiahVFX"><img
                                            class="header__social-logo-item" loading="lazy"
                                            src="../../content/images/icon-twitter.svg"
                                            alt="Icône de Twitter" width="24" height="24"></a></li>
                            <li data-action="trailer" data-type="white"><a class="header__social-logo-link" href="https://www.instagram.com/zekiahrr"><img
                                            class="header__social-logo-item" loading="lazy"
                                            src="../../content/images/icon-instagram.svg"
                                            alt="Icône de Instagram" width="24" height="24"></a></li>
                            <li data-action="trailer" data-type="white"><a class="header__social-logo-link" href="https://www.youtube.com/@Zekiah"><img
                                            class="header__social-logo-item" loading="lazy"
