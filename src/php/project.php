            ...
            <a class="tilt" href="https://sacha-meunier.com">
                <div data-tilt-element class="projects-card bg-cyan">
                    ...
                    <p id="project-1-desc" class="projects-card-p" data-animate="slide-up-fade" itemprop="description">
                        Création d'un portfolio personnel utilisant les technologies HTML, SCSS, TypeScript et
                        Wordpress.
                    </p>
            ...
            <a class="tilt" href="https://sef.sacha-meunier.com">
                <div data-tilt-element class="projects-card bg-d-purple">
                    ...
                    <p id="project-2-desc" class="projects-card-p" data-animate="slide-up-fade" itemprop="description">
                        Projet bénévole pour une ASBL de Huy. Rebranding, stratégies et mise en avant de leurs services
            ...
            <a class="tilt" href="/">
                <div data-tilt-element class="projects-card bg-orange">
                    ...
                    <p id="project-3-desc" class="projects-card-p" data-animate="slide-up-fade" itemprop="description">
                        Recréation de la page d'accueil d'un site web existant et transformation de son contenu en notre
                        CV.
                    </p>
